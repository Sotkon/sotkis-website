  ...
  return (
    <div className="paylt">
      ...
      <section className="paylt__how-it-works-section paylt__how-it-works-section--rebuilt section">
        <div className="container">
          <AnimateOnScroll animation="fadeSlideUp" delay={0} duration={0.8}>
            <h2 className="paylt__section-title">{tAny.contentores.title}</h2>
          </AnimateOnScroll>
          <AnimateOnScroll animation="fadeBlur" delay={200} duration={1}>
            <div className="paylt__rebuilt">
              <div className="paylt__rebuilt-badge">{tAny.howItWorks.title}</div>
              ...
              <div className="paylt__rebuilt-pills">
                ...
                <div className="paylt__rebuilt-pill-wrap">
                  ...
                  <div className="paylt__rebuilt-pill">{tAny.scheme.pointsHighlight}</div>
                </div>
                <div className="paylt__rebuilt-pill-wrap">
                  <img src="data:image/webp;base64," alt="" className="paylt__rebuilt-trophy" aria-hidden="true" />
                  <div className="paylt__rebuilt-pill">{tAny.scheme.openingHighlight}</div>
                </div>
              </div>
              <div className="paylt__rebuilt-layout">
                <div className="paylt__rebuilt-col">
                  <div className="paylt__rebuilt-detail">
                    <p><strong>{tAny.scheme.billingDetail}</strong></p>
                  </div>
                  <div className="paylt__rebuilt-icon-col">
                    ...
                    <p className="paylt__rebuilt-icon-sub">{language === 'pt' ? 'c/restritor de volume' : 'with volumetric restrictor'}</p>
                  </div>
                </div>
                <div className="paylt__rebuilt-col">
                  <div className="paylt__rebuilt-detail">
                    <p>{tAny.scheme.pointsDetail1}</p>
                  </div>
                  <div className="paylt__rebuilt-icon-col">
                ...
                <div className="paylt__rebuilt-col">
                  <div className="paylt__rebuilt-detail">
                    <p>{tAny.scheme.openingDetail1}</p>
                  </div>
                  <div className="paylt__rebuilt-icon-col">
                ...
                <div className="paylt__rebuilt-col">
                  <div className="paylt__rebuilt-detail">
                    <p>{tAny.scheme.openingDetail2}</p>
                  </div>
                  <div className="paylt__rebuilt-icon-col">
                ...
                <div className="paylt__rebuilt-slide">
                  <div className="paylt__rebuilt-slide-content">
                    ...
                    <div className="paylt__rebuilt-slide-icon">
                      ...
                      <p className="paylt__rebuilt-slide-icon-sub">{language === 'pt' ? 'c/restritor de volume' : 'with volumetric restrictor'}</p>
                    </div>
                  </div>
          ...
          <div className="paylt__video-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="paylt__video-modal-iframe-wrapper">
              <iframe
                width="853"
                height="480"
                src="https://www.youtube.com/embed/6IM0r2d7LXE?controls=1&rel=0&modestbranding=1"
