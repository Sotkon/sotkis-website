        ...
        <div className="footer__content">
          ...
          <div className="footer__section footer__section--brand">
            ...
            <div className="footer__social-icons">
              <a href="https://www.facebook.com/SotkonWasteSystems" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-icon footer__social-icon--facebook">
              ...
              <a href="https://www.youtube.com/user/sotkonwastesystems" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="footer__social-icon footer__social-icon--youtube">
                <svg width="23.4" height="23.4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://www.linkedin.com/company/sotkon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="footer__social-icon footer__social-icon--linkedin">
                <svg width="23.4" height="23.4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
